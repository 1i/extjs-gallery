...
Ext.define('Ext.grid.locking.Lockable', {
    ...
    injectLockable: function() {
        ...
        // These delayed functions clear each view's isReflecting flag after the scroll has settled.
        // This flag prevents scrolling feedback from the controlled side.
        me.endLockedViewScroll = Ext.Function.createDelayed(me.endLockedViewScroll, 100, me);
        me.endNormalViewScroll = Ext.Function.createDelayed(me.endNormalViewScroll, 100, me);
    ...
    onLockedViewScroll: function() {
        ...
        // The isReflecting flag prevents feedback
        if (!lockedView.isReflecting) {
            if (normalDom.scrollTop !== lockedDom.scrollTop) {
                normalView.isReflecting = true;
                normalDom.scrollTop = lockedDom.scrollTop;

                // This is a deferred function which clear the isReflecting flag after the scrolling has settled.
                me.endNormalViewScroll();
            }
        }
    },

    endNormalViewScroll: function() {
        this.normalGrid.getView().isReflecting = false;
    },
    ...
    onNormalViewScroll: function() {
        ...
        // The isReflecting flag prevents feedback
        if (!normalView.isReflecting) {
            if (lockedDom.scrollTop !== normalDom.scrollTop) {
                lockedView.isReflecting = true;
                lockedDom.scrollTop = normalDom.scrollTop;

                // This is a deferred function which clear the isReflecting flag after the scrolling has settled.
                me.endLockedViewScroll();
            }
        }
    },

    endLockedViewScroll: function() {
        this.lockedGrid.getView().isReflecting = false;
    },
